...
<div class=''>
		...
		<div class='inputQuery'>
			<form action='scServlet' method='post'>
				学号:  <input type="text" value="" name="studentID" required maxlength="5"><br>
				学年:  <input type="text" value="" name="aaa"  maxlength="5"><br>
				学期:  <input type="text" value="" name="bbb"  maxlength="5"><br>
		...
		<div class='studentSche' >
			...
			<tr>
					...
					<tr>
						...
						<td align="center"><%= stu.getInstructor_id()%></td>
						<td align="center"><%=stu.getInstructor_name()%></td>
					</tr>
					<%	
						}
						}
